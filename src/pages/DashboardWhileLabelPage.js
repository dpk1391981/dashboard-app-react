...
import { GetDashboardById } from "../actions/dashboard";
...
const DashboardWhileLabelPage = ({ GetDashboardById, loading, dashboard_detail }) => {
      ...
      {loading ? (
        ...
        <>
          {dashboard_detail ? (
            ...
            <>
              <Page404 title={"Unauthorized Page"} />
            </>
          )}
        </>
      )}
